...
--
-- Servidor: localhost
-- Tiempo de generación: 27-11-2022 a las 08:52:53
...
(2, 10254, 'CC', 'Anderson', 'Orozco', '3219238493', '2022-11-29', 'anderson07rolon@gmail.com', '1234', 'sa', '1', 'as', 'as', 'Mañana', 1, 1, NULL);
...
(1, 'Producto 1', 24, 15000, 0, 1),
(2, 'Producto 2', 30, 20000, 1, 1);
...
--
ALTER TABLE `cliente`
  MODIFY `id_cliente` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `entrenador`
  MODIFY `id_entrenador` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
